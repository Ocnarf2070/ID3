	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			*/
			...
			System.out.println("Prediccion Simpsons");
			String listaA="";
					
			String[] registro1= {"corto","alto","menor"};
			String[] registro2= {"largo","bajo","menor"};
					
			for(String at:dt.atributos) listaA=listaA + at + ";";
			String rP="";
			for(String v:registro1) rP= rP+v+"-";
			
			System.out.println(listaA + '\n'+ rP + ">" + dt.prediction(registro1));
			System.out.println("");
			
			String rP2="";
			for(String v:registro2) rP2= rP2+v+"-";
			System.out.println(listaA + '\n'+ rP2 + ">" + dt.prediction(registro2));
		} catch (IOException e) {
